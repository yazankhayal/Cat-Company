...
Route::group(['prefix' => 'dashboard', 'middleware' => 'dashboard'], function () {
    ...
    Route::group(['prefix' => '/services'], function () {
        ...
        Route::get('/for/sell', 'Dashboard\ProductsController@for_sell')->name('dashboard_products.for_sell');
        Route::get('/for/sell/add_edit/{id?}', 'Dashboard\ProductsController@for_sell_add_edit')->name('dashboard_products.for_sell_add_edit');

        Route::get('/previous', 'Dashboard\ProductsController@previous')->name('dashboard_products.previous');
        Route::get('/previous/add_edit/{id?}', 'Dashboard\ProductsController@previous_add_edit')->name('dashboard_products.previous_add_edit');
