        ...
        if ($validation->fails())
        {
            ...
            if($special == null){
                DB::transaction(function()
                {
                    ...
                    $special->avatar1 = parent::upladImage(Input::file('avatar1'), 'special');
                ...
                DB::transaction(function()
                {
                    ...
                    if (Input::hasFile('avatar1')) {
                        //Remove Old
                        if ($special->avatar1 != 'special/no.png') {
                            if (file_exists(public_path($special->avatar1))) {
                                unlink(public_path($special->avatar1));
                            }
                        }
                        //Save avatar
                        $special->avatar1 = parent::upladImage(Input::file('avatar1'), 'special');
